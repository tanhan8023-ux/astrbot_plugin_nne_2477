...
AstrBot 诺奈 NNE-2477 专属活人感插件。安装并启用后，只会加载诺奈人设。
...
插件不会读取 `persona_private.json`、`persona.json`、环境变量或其他角色文件。
代码内置的兜底人设也是诺奈，专属文件丢失时也不会变成其他角色。

如果同时启用了原版活人感插件，请先停用原版，避免两份人设提示同时注入。
